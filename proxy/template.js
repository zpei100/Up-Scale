module.exports = function(hosts, initialStates, htmls) {
  ...
  <head>
    ...
    <link rel="stylesheet" href="${hosts.reviewsHost}/styles.css">
    <link rel="stylesheet" href="${hosts.productInfoHost}/styles.css">
  ...
  <body>
    ...
    <script> = window. = ${JSON.stringify(initialStates.productInfoInitialState)}</script>
    <div id="app">
    ...
    <script src="${hosts.galleryHost}/gallerybundle.js"></script>
    <script src="${hosts.overviewsHost}/bundle.js"></script>
    <script src="${hosts.productInfoHost}/info.bundle.js"></script>
  </body>
  </html>
  `;
};
